...
const siteTitle = `${context.name} | ${context.role}`
  ...
  app: {
    head: {
      ...
      meta: [
        ...
        { hid: 'description', name: 'description', content: 'Arthur Boucard\'s portfolio.' },
        { hid: 'og:title', property: 'og:title', content: siteTitle },
        { hid: 'og:description', property: 'og:description', content: 'Arthur Boucard\'s portfolio.' },
